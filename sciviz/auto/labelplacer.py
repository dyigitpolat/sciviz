...
def place_label(
    ...
    *,
    ...
    the element that requested it. It does not affect geometry.
    """
    ...
    # Build the full candidate record once so we can both score and (on
    ...
    for (cx, cy), side, extrap in candidates:
        ...
        records.append(LabelCandidate(
            rect=rect, side=side, overlap=overlap,
